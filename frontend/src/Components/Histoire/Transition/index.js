...
const Transition = () => {
    ...
    return(
        ...
        <button className={styles.animaux}><Link to='/prevenirlesparents'>Prévenir ses parents</Link></button>
        <button className={styles.animaux}><Link to='/fuircommeunvoleur'>S'enfuir comme un voleur</Link></button>
