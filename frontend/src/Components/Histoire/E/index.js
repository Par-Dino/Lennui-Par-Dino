...
const E = () => {
    ...
    return(
        ...
        <p className={styles.text}>L’enfant s’exécuta, mais rien ne semblait se passer. Il commença a rire doucement, tant la situation était ridicule, quand subitement tout s’écroula autour de lui. Sa chambre avait disparue. Les murs, le chat, le lit et la table basse, tout. Il avait le sentiment de flotter dans le néant. Il se sentait dériver lentement mais n’avait aucun point de repère auquel s’accrocher. Subitement, il fut aveuglé par deux masses lumineuses qui venaient d’apparaître devant ses yeux. C’était deux yeux de chats scintillants. Une voix s’élevât.</p>
                     </Link></div>
                     {/* DROITE */}
